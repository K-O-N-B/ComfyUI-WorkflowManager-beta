    ...
    try {
      ...
      container.innerHTML = `
        <div class="nz-manager">
          ...
          <!-- 主界面警告提示 -->
          <div class="nz-main-warning">
            <div class="nz-warning-content">
              <i class="pi pi-exclamation-triangle nz-warning-icon"></i>
              <span class="nz-warning-text">在使用本插件的同时，请不要使用官方的工作流管理功能和TAB功能，会造成保存混乱和冲突！</span>
            </div>
          </div>
